...
const BigMacIndex = () => {
  ...
  return (
    <div className="bg-neutral-700 border border-neutral-600 rounded-2xl p-5 min-h-[300px] flex flex-col justify-between">
      <div>
        ...
        <div className="bg-neutral-600/50 rounded-xl p-4 border border-neutral-500">
          <div className="flex items-end gap-2 mb-2">
            <span className="text-3xl font-bold text-neutral-50">{absValuation.toFixed(1)}%</span>
            <span className={`text-lg font-medium mb-1 ${isOvervalued ? "dark:text-red-400 text-red-600" : "dark:text-green-400 text-green-600"}`}>
      ...
      <div className="mt-6">
        <div className="flex items-center justify-between text-xs text-neutral-200 font-medium mb-2">
          <span>-50% Undervalued</span>
          <span>Fair Value</span>
          <span>+50% Overvalued</span>
        </div>
        <div className="h-2 w-full bg-neutral-600 rounded-full overflow-hidden relative">
          <div className="absolute top-0 bottom-0 left-1/2 w-px bg-neutral-400 z-10" />
          <motion.div
